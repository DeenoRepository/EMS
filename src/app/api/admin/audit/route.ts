...
import { auditLogMemory } from "@/lib/telemetry/logger";
...
// SEC-08: POST endpoint удалён для предотвращения подделки audit записей
// Audit записи должны создаваться только системой через logEvent()
// Для добавления новых типов событий расширьте logEvent() в src/lib/telemetry/logger.ts

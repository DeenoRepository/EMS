    ...
    <ShellLayout>
      <main className="w-full px-5 py-6 md:px-8 space-y-6">
        <PageHeader
          ...
          description={`Централизованный складской учет запчастей и материалов (найдено ${filteredItems.length} из ${items.length} поз.).`}
          breadcrumbs={[
            { title: "Главная", href: "/" },
            { title: "WMS Складной учет", href: "/modules/wms" },
            { title: "Каталог ТМЦ" },
          ]}
          actions={
            <>
